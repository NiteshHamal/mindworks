    ...
    (function () {
        ...
        function i(t) {
            (this.element = t),
                ...
                (o += 1),
                y.windowContext ||
                    ((y.windowContext = !0), (y.windowContext = new i(window))),
        ...
        (i.prototype.add = function (t) {
            ...
            (i.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on("resize.waypoints", function () {
                    e.didResize ||
                        ((e.didResize = !0), y.requestAnimationFrame(t));
                });
            }),
            (i.prototype.createThrottledScrollHandler = function () {
                ...
                this.adapter.on("scroll.waypoints", function () {
                    (e.didScroll && !y.isTouch) ||
                        ((e.didScroll = !0), y.requestAnimationFrame(t));
                });
            }),
                ...
                (t = {
                    ...
                    for (var s in this.waypoints[n]) {
                        ...
                        u.element !== u.element.window &&
                            ...
                            (p = !l && !h),
                            !w && l && h
                                ? (u.queueTrigger(r.backward),
                                  (o[u.group.id] = u.group))
                                : !w && p
                                ? (u.queueTrigger(r.forward),
                                  (o[u.group.id] = u.group))
                                : w &&
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var o = 0, n = e.length; o < n; o += 1) {
                        var r = e[o];
                        (!r.options.continuous && o !== e.length - 1) ||
                            r.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
