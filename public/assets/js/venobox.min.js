!(function (e, t) {
    ...
    function G() {
        return (
            ...
            (!r.settings.onPreClose ||
                ...
                (r.settings.onPreClose(r, p, j, H),
                !1 !== r.settings.onPreClose)) &&
    ...
    function ne(e, t, o) {
        ...
        a.classList.remove("vbox-loading"), oe("animated");
    }
    function se() {
        var e;
        if (
            ((e = x), (R.innerHTML = e), (g = R.querySelectorAll("img")).length)
        ) {
            let e = 0;
            F(g, function (t) {
                let o = t.src;
        ...
        } else a.classList.remove("vbox-loading"), oe("animated");
    }
    function ie(e) {
        if (!y) {
    ...
    function re(e) {
        if (W && !y) {
            (Q = e.pageX), (v = e.pageY), (d = Q - D), (c = v - A);
            let t = Math.abs(d);
    ...
    function le(e) {
        ...
        e.settings.share &&
            ...
            (function (e) {
                if (navigator.canShare) {
                    ...
                    o.insertAdjacentHTML(
                        "beforeend",
                        '<div class="vbox-link-btn vbox-share-mobile">' +
                            I +
                            "</div>"
                    ),
                        o
                ...
                o.insertAdjacentHTML(
                    "beforeend",
                    '<a target="_blank" href="' + e + '" download>' + B + "</a>"
                ),
                    o.insertAdjacentHTML(
                        "beforeend",
                    ...
                    o
                        ...
                        .addEventListener("click", function (t) {
                            ...
                            navigator.clipboard.writeText(e).then(
                                function () {
                                    o.innerHTML =
                                        '<div class="vbox-tooltip-inner">Copied</div>';
                                },
                                function () {
            ...
            m.length >= 1
                ...
                : (p = 1),
            L
                ? t.classList.remove("vbox-hidden")
                : t.classList.add("vbox-hidden"),
            "" !== P
            ...
            (w || h) && e.settings.navTouch
                ? (a.classList.add("vbox-grab"),
                  ...
                  a.addEventListener("mousemove", re, !1))
        ...
        w ? r.classList.remove("vbox-hidden") : r.classList.add("vbox-hidden"),
            h
                ? i.classList.remove("vbox-hidden")
    ...
    const be = function (e) {
        ...
        return (
            ...
            (function (e, t) {
                ...
                let o =
                    t.jQuerySelectors || document.querySelectorAll(t.selector);
                if (
                    ((s =
                    ...
                    F(o, function (e) {
                        ...
                        (e.settings = t),
                            ...
                            e.addEventListener("click", function (t) {
                                return t.preventDefault(), e.blur(), ue(e), !1;
                            });
                    }),
                    t.popup)
                ) {
    ...
    return (
        "function" == typeof jQuery &&
            jQuery.fn.extend({
                venobox: function (e) {
                    const t = e || {};
                    (t.jQuerySelectors = this), new be({ pluginoptions: t });
                },
            }),
        be
    );
