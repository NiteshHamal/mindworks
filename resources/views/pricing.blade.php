                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="pricing-item">
                                                ...
                                                <div class="pricing-content">
                                                    ...
                                                    <h3 class="title">NPR.35,000<span>/mo</span></h3>
                                                    <ul class="pricing-list">
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Ranking Upto 15 Keywords</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Site Audit</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Competitor Analysis</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>URL and Image Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>2 Blog Article</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Few Existing Content Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Basic Site Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Basic Link Building</li>
                                                    </ul>
                                                    <a href="pricing.html" class="pricing-btn">Take My Plan</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="pricing-item active">
                                                ...
                                                <div class="pricing-content">
                                                    ...
                                                    <ul class="pricing-list">
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Ranking Upto 30 Keywords</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Site Audit</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Competitor Analysis</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Meta Tag, URL, and Image Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>4 Blog Articles</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Existing Content Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Site and Page Speed Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>High Authority Link Building</li>
                                                    </ul>
                                                    <a href="pricing.html" class="pricing-btn">Take My Plan</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="pricing-item">
                                                ...
                                                <div class="pricing-content">
                                                    ...
                                                    <ul class="pricing-list">
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Ranking Upto 60 Keywords</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Site Audit</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Competitor Analysis and Backlink Analysis</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Meta Tag, URL, and Image Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>8 Blog Articles</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Existing Content Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>Full TEchnical SEO Optimization</li>
                                                        <li><i class="fa-regular fa-chevrons-right"></i>High Authority Link Building</li>
                                                    </ul>
                                                    <a href="pricing.html" class="pricing-btn">Take My Plan</a>
                                                </div>
