        ...
        <div class="row footer-wrap pt-120 pb-120">
            <div class="col-lg-5 col-md-6">
                <div class="footer-widget">
                    <div class="site-logo">
                        <a href="{{url('/')}}"><img class="footer-logo" src="{{url('assets/img/mindworks-logo-white.webp')}}" alt="logo"></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-widget">
                    ...
                    <p class="desc">Email: info@mindworksme.com<br>Phone: 9851014752 <br> Address: Kupondole, Lalitpur, Nepal<br><br>Mon-Fri: 9AM-6PM<br>Sat-Sun: Closed</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <ul class="footer-list">
                        <li><a href="{{url('about')}}"><i class="fa-sharp fa-regular fa-chevron-right"></i>About</a></li>
                        <li><a href="{{url('service')}}"><i class="fa-sharp fa-regular fa-chevron-right"></i>Services</a></li>
                        <li><a href="{{url('projects')}}"><i class="fa-sharp fa-regular fa-chevron-right"></i>Projects</a></li>
                        <li><a href="{{url('faq')}}"><i class="fa-sharp fa-regular fa-chevron-right"></i>FAQ</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="copyright-content">
                <p>Copyright © Mindworks 2024 | <span> info@mindworksme.com</span>, All Rights Reserved.</p>
                <ul class="copy-list">
